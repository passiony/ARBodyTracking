...
{
    [Header("Test")] [SerializeField] private float testTimeBetweenUpdates = 1f;

    [SerializeField] private Vector3 robotInitialPosition = new Vector3(0, 0, 3f);

    [Header("Random Robot Pose")] [SerializeField]
    private Vector3 minRandomPositionChange = Vector3.zero;

    [SerializeField] private Vector3 maxRandomPositionChange = Vector3.zero;

    [SerializeField] private Vector3 minRandomRotationChange = Vector3.zero;

    [SerializeField] private Vector3 maxRandomRotationChange = Vector3.zero;

    [Header("Random Joint Pose")] [SerializeField]
    private Vector3 minRandomJointPositionChange = Vector3.zero;

    [SerializeField] private Vector3 maxRandomJointPositionChange = Vector3.zero;

    [SerializeField] private Vector3 minRandomJointRotationChange = Vector3.zero;

    [SerializeField] private Vector3 maxRandomJointRotationChange = Vector3.zero;

    [Header("Random Scale Factor")] [SerializeField]
    private float minRandomHeight = 1.0f;

    [SerializeField] private float maxRandomHeight = 1.0f;
    ...
    {
        isTesting = false;
        StopCoroutine("TestPositionUpdate");
    }
    public void StartTest()
    {
        ...
        isTesting = true;
        StopCoroutine("TestPositionUpdate");
        StartCoroutine("TestPositionUpdate");
    }
    private IEnumerator TestPositionUpdate()
    {
