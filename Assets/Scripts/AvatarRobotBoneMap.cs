...
public class AvatarRobotBoneMap : MonoBehaviour
{
    ...
    {
        //Hips
        Hips.avatarBone = Root.avatarBone.GetChild(0);
        
        //右腿左腿
        RightLeg.avatarBone = RightUpLeg.avatarBone.GetChild(0);
        RightFoot.avatarBone = RightLeg.avatarBone.GetChild(0);
        RightToes.avatarBone = RightFoot.avatarBone.GetChild(0);
        RightToesEnd.avatarBone = RightToes.avatarBone.GetChild(0);
        
        //左腿
        LeftLeg.avatarBone = LeftUpLeg.avatarBone.GetChild(0);
        LeftFoot.avatarBone = LeftLeg.avatarBone.GetChild(0);
        LeftToes.avatarBone = LeftFoot.avatarBone.GetChild(0);
        LeftToesEnd.avatarBone = LeftToes.avatarBone.GetChild(0);

        //Spine
        Spine2.avatarBone = Spine1.avatarBone.GetChild(0);
        Spine3.avatarBone = Spine2.avatarBone.GetChild(0);
        Spine4.avatarBone = Spine3.avatarBone.GetChild(0);
        Spine5.avatarBone = Spine4.avatarBone.GetChild(0);
        Spine6.avatarBone = Spine5.avatarBone.GetChild(0);
        Spine7.avatarBone = Spine6.avatarBone.GetChild(0);
        
        //neck
        Neck2.avatarBone = Neck1.avatarBone.GetChild(0);
        Neck3.avatarBone = Neck2.avatarBone.GetChild(0);
        Neck4.avatarBone = Neck3.avatarBone.GetChild(0);
        Head.avatarBone = Neck4.avatarBone.GetChild(0);
        
        //leftHand
        LeftArm.avatarBone = LeftShoulder1.avatarBone.GetChild(0);
        LeftForearm.avatarBone = LeftArm.avatarBone.GetChild(0);
        LeftHand.avatarBone = LeftForearm.avatarBone.GetChild(0);
                
        //rightHand
        RightArm.avatarBone = RightShoulder1.avatarBone.GetChild(0);
        RightForearm.avatarBone = RightArm.avatarBone.GetChild(0);
        RightHand.avatarBone = RightForearm.avatarBone.GetChild(0);
    }
}
